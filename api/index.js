...
const token = '2117116015:AAHzNIP1n2MynoMZ8WFeOFYkEufavNQO84E';
...
bot.onText(/\/show_url/, (msg) => {
    ...
    bot.sendMessage(
        global_msg_id,
        `
            https://esp-telebot-1.herokuapp.com/api/sensor/123/65/78 \n
            https://esp-telebot-1.herokuapp.com/api/test/cobacoba
        `
    );
});
